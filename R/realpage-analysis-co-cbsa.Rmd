...
here::i_am("R/realpage-analysis-co-cbsa.Rmd")

```

Plan:
- Metro areas with the largest increase in rents vs increase in rent burden
- Metro areas with the largest increase in rents vs eviction rate
- Maybe: Specific Realpage cities: Washington, D.C., Seattle, Denver, Nashville, Atlanta rent increase 

Data needs:
- Pct increase in rents
- Pct increase in pop that is rent burdened
- Eviction rates in 2021? 2018?


```{r}

# Tract level rent estimates?
...
# eviction_proprietary_co_2013 <- data.table::fread("https://eviction-lab-data-downloads.s3.amazonaws.com/data-for-analysis/county_proprietary_valid_2000_2018.csv") %>%
#   mutate(
#     geoid_co = stringr::str_pad(cofips, 5, side = "left", pad = "0")
#   ) %>%
#   filter(year == 2013) %>%
#   rename(
#     filings_2013 = filings,
#     filing_rate_2013 = filing_rate,
#     threatened_2013 = threatened,
#     threatened_rate_2013 = threatened_rate
#   ) %>%
#   select(geoid_co, filings_2013, filing_rate_2013, threatened_2013, threatened_rate_2013)
# 
# eviction_proprietary_co_2018 <- data.table::fread("https://eviction-lab-data-downloads.s3.amazonaws.com/data-for-analysis/county_proprietary_valid_2000_2018.csv") %>%
#   mutate(
#     geoid_co = stringr::str_pad(cofips, 5, side = "left", pad = "0")
#   ) %>%
#   filter(year == 2018) %>%
#   rename(
#     filings_2018 = filings,
#     filing_rate_2018 = filing_rate,
#     threatened_2018 = threatened,
#     threatened_rate_2018 = threatened_rate
#   ) %>%
#   select(geoid_co, filings_2018, filing_rate_2018, threatened_2018, threatened_rate_2018)
# 
# eviction_proprietary_co <- inner_join(
#   eviction_proprietary_co_2013,
#   eviction_proprietary_co_2018,
#   by = "geoid_co"
# ) %>%
#   mutate(
#     pct_change_threatened_rate = ifelse(
#       threatened_rate_2013 > 0,
#       (threatened_rate_2018 - threatened_rate_2013) / threatened_rate_2013, NA),
#     pct_change_filing_rate = ifelse(
#       filing_rate_2013 > 0,
#       (filing_rate_2018 - filing_rate_2013) / filing_rate_2013, NA),
#   )
...
fig <- dta %>%
  # filter(housing_units_renter_occupied_2018 > 200000) %>%
